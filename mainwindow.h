...
void on_previos_b_clicked();
void on_next_b_clicked();

private:

pod_play *comm_interface;   ///my own class that responsible for the comuniation with other instances of this application over shared memory
